...
<center><h2><font size="6"><font color="#1C2870"><font face="comic sans ms">LOGIN</font></font></font></h2></center>
    ...
    <form action= "proses_login.php" method="post">
        ...
        <button style="background-color:#1C2870;" type="batal"><font color="white"><font face="comic sans ms">Batal</font></font></button>
        ...
        <p><font face="comic sans ms">Belum punya akun?</font>
            <a href="daftar.php"><font face="comic sans ms">Daftar disini</font></a>
        </p>
        </div>
    </form>
    </center>
